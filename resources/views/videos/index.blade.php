<x-app-layout>
    ...
    <div class="flex flex-row  flex-wrap justify-center items-center p-4 bg-white rounded-lg w-full sm:w-3/4 mb-4 m-auto mt-4 shadow">
    ...
    <div class="bouton w-full sm:w-3/4 m-auto">

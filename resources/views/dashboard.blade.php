<x-app-layout>
    ...
    @if($user->club_id == 1)
    <div class="bg-white shadow rounded-lg m-auto w-3/4 sm:w-1/3 mt-16 p-4">
        ...
        <div class="p-4 bg-white rounded-lg shadow max-w-7xl lg:mx-auto mx-4 lg:px-8">
            <div class="">
                <div class="">
                    ...
                    @else
                        @if($user->role == "staff")
                        <p>Votre club : <a href="{{route('admin.clubs.edit', $club)}}"><span class="font-bold hover:text-indigo-500">{{$user->club->name}} <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 inline-block pb-1" viewBox="0 0 20 20" fill="currentColor">
